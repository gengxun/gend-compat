...
/*
  使用实例------------------------------------------------------
  Gend_Image_Zoom::toZoom('bb.jpg',130,0,'_small');//缩放图片,高自适应
  Gend_Image_Zoom::toZoom('bb.jpg',0,500,'_small');//缩放图片,宽自适应
  Gend_Image_Zoom::toZoom('bb.jpg',200,100,'_small');//缩放图片,固顶宽高
  Gend_Image_Zoom::toSeal('bb.jpg','hello');//增加水印
*/
?>